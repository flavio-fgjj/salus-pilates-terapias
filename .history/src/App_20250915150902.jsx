...
function App() {
  return (
    <div>
      ...
      <Footer />
      {/* Box de Promoção */}
      <div className="fixed bottom-6 left-6 max-w-xs bg-white rounded-xl shadow-2xl border border-[#B7D0CA]/20 p-4 z-50 animate-pulse">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 inline-flex items-center justify-center w-14 h-14 rounded-full shadow-lg bg-[#25D366] hover:brightness-95 text-white z-50"
        aria-label="WhatsApp"
      >
