...
function App() {
  ...
  return (
    <div>
      ...
      {/* Box de Promoção */}
      {isPromoBoxVisible && (
        <div className="fixed bottom-6 left-4 right-4 sm:left-6 sm:right-auto sm:max-w-xs bg-gradient-to-br from-[#B7D0CA] to-[#9BC4B8] rounded-xl shadow-2xl border border-white/20 p-4 z-50">
