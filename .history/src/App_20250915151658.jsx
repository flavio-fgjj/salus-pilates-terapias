      ...
      {isPromoBoxVisible && (
        ...
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="flex-shrink-0 w-7 h-7 rounded-full bg-white/30 hover:bg-white/50 flex items-center justify-center transition-all duration-200 hover:scale-110"
