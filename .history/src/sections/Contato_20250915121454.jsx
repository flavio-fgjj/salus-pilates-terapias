    ...
    <div className="px-4 md:px-6">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-transparent hover:bg-[#B7D0CA]/10 text-slate-800 border border-[#B7D0CA] font-semibold transition"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-transparent hover:bg-emerald-50 text-emerald-600 border border-emerald-500 font-semibold transition"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
