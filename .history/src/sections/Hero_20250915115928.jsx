    ...
    <div className="relative w-full px-4 md:px-6">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
          <a href="#contato" className="inline-flex items-center justify-center rounded-md bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 shadow-lg shadow-emerald-500/30 transition">
            Agendar aula
          </a>
          <a href="#sobre" className="inline-flex items-center justify-center rounded-md bg-white/10 hover:bg-white/15 backdrop-blur text-white border border-white/20 font-semibold px-6 py-3 transition">
            Conheça a Salus
          </a>
        </div>
      </div>
