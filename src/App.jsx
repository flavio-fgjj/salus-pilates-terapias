      ...
      {isPromoBoxVisible && (
        ...
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="flex-shrink-0 w-7 h-7 rounded-full bg-white/40 hover:bg-white/60 flex items-center justify-center transition-all duration-200 hover:scale-110"
